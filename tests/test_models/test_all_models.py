...
def test__all__models_in_registry():
    ...
    assert not missing_models, "There are models in __all__ that are missing from the ModelRegistry."
...
def test_models_registry_in__all__():
    ...
    assert not missing_models, "There are models in ModelRegistry that are missing from __all__."
